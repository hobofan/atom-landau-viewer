...
var JsCadViewerView = require('./landau-viewer-view');
...
module.exports = {
  ...
  activate: function ( /* state */ ) {
    // console.log('landau-viewer.activate');

    this.subscriptions = new CompositeDisposable;

    this.subscriptions.add(atom.commands.add('atom-workspace', {
      'landau-viewer:toggle': this.toggle.bind(this)
    }));

    this.subscriptions.add(atom.commands.add('atom-workspace', {
      'landau-viewer:preview-file': this.previewFile.bind(this)
    }));

    this.subscriptions.add(atom.workspace.observeActivePaneItem(function ( /* paneItem */ ) {
      // console.log('landau-viewer.subscription.observeActivePaneItem', paneItem);
    ...
    return atom.workspace.addOpener(function (uriToOpen) {
      // console.log('landau-viewer.addOpener', uriToOpen);
  ...
  */
   ...
   * @return {TextEditor}    A promise that resolves to the `TextEditor` of the landau-viewer.
   */
  preview: function (editor, uri) {
    return atom.workspace.open(uri, {
      ...
      view.events.on('error', function (err) {
        ...
        console.error('landau-viewer.preview ERROR:', err);
  ...
  toggle: function () {
    ...
    // console.error('landau-viewer.toggle', uri);
  ...
  previewFile: function previewFile(e) {
    ...
    // console.warn('landau-viewer.previewFile', selection, editor && editor.getTitle() || 'no editor');
    this.preview(editor, 'landau-viewer://' + selection).then(function (view) {
